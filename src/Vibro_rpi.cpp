...
*/
    ...
    */
        ...
        i2c_writeByte(VIBRO_MODE_REG,settings.device_rdy); // decide on whether we need both
...
void VIBRO4_rpi::playHaptic(){
        
        // Wake up driver by removing from standby mode 
        i2c_writeByte(VIBRO_MODE_REG,motorSettings.device_rdy);
